...
<template>
<div class="">
  <h2 class="flex font-extralight text-6xl tracking-tight  justify-center items-center">Family Member</h2>
  </div>
<div class=" flex items-center justify-center p-8" >

  <div class=" flex-row space-y-4">
    <img class = "h-64" src="../assets/my_personal_files1.svg" alt="Family Member">
         </div>
    <div>
